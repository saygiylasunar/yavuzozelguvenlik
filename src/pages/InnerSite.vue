...
import { navigation } from '../content/sitePages.js'
...
onMounted(() => {
  ...
  document.title = `${props.page.title} | Yavuz Özel Güvenlik`
  ...
  description.content = props.page.lead || 'Yavuz Özel Güvenlik · Akşehir, Konya'
  window.scrollTo(0, 0)
})
        ...
        <div class="container inner-content-grid">
          ...
          <aside class="inner-sidebar">
            <div class="inner-contact-card">
              <p class="eyebrow">Hızlı iletişim</p>
